...
cmd /k "cd /d ..\vbot\scripts & activate & cd /d ..\..\bot & python -m debugpy --listen 0.0.0.0:5678 --wait-for-client ./run.py %phone% %server% %tiempo% %tiempo_modo% %grupos% %lista_grupos% %desc%"